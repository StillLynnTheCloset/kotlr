 ...
 * @version 1.0.0
 */
internal class UserLikesWrapperJsonAdapter(moshi: Moshi) {
     ...
     */
    @FromJson
    fun fromJson(reader: JsonReader): WrapperInterface<ResponseUserLikes.Body> {
        return when (reader.peek()) {
            JsonReader.Token.BEGIN_OBJECT -> ResponseUserLikes.Wrapper(body = responseAdapter.fromJson(reader))
     ...
     */
    @ToJson
    fun toJson(writer: JsonWriter, value: WrapperInterface<ResponseUserLikes.Body>?) {
        if (value?.error != null) {
