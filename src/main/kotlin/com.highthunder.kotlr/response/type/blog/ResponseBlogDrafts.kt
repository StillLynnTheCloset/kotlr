...
/**
 * ResponseBlogDrafts - The response to a request for a Blog's drafts.
 *
 * @author highthunder
 * @since 2018-11-06
 */
public interface ResponseBlogDrafts {
    /**
    ...
    /**
     * Adapter is [BlogDraftsWrapperJsonAdapter].
     *
     ...
     * @param posts A list of posts from this blog's drafts.
     */
    @JsonClass(generateAdapter = true)
