 ...
 * @param captionAbstract A short summary of the caption.
 ...
 * @param panorama Is the photo in this post a panorama
 * @param photosetLayout A string defining the layout of this post. It will be a string of numbers where each digit defines the number of image on that row.
 *  ex. "121" means the 1st row has a single image, the 2nd row has the next 2 images, and the 3rd row has the 4th and final image.
 */
