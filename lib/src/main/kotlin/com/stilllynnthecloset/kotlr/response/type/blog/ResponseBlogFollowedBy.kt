...
/**
 * ResponseBlogFollowedBy - The response to a request for whether your blog is followed by the query blog.
 *
...
public interface ResponseBlogFollowedBy {
     ...
     *
     * @param followedBy Indicates whether your blog is followed by the query blog.
     */
    @JsonClass(generateAdapter = true)
